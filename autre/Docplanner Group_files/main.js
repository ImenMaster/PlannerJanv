!(function (e) {
    ...
    "Cw/M": function (e, t) {
        var n,
            ...
            i = 10;
        function o(e, t, n, r) {
            if ((t.hide(), n.hide(), "" !== r.department)) {
                var i = e.find("[data-department=" + r.department + "]");
                i.show(), "" !== r.location ? i.find("[data-location=" + r.location + "]").show() : i.find(".positions__single").show();
            } else {
                var o = n;
                "" !== r.location && (o = e.find("[data-location=" + r.location + "]")), o.show(), o.parent(".positions__department").show();
            }
            addResizeEvent(a), s(), $(window).scroll(s);
        }
        function a() {
            window.innerHeight || document.documentElement.clientHeight, (n = window.innerWidth || document.documentElement.clientWidth);
            var e = $(".offices__slider");
            n <= 870 && !e.hasClass("slick-slider") && (e.find(".office").addClass("fade-elements__visible"), e.slick({ speed: 300, dots: !0, variableWidth: !0, centerMode: !0, infinite: !1 })),
                n > 870 && e.hasClass("slick-slider") && e.slick("unslick");
        }
        function s() {
            var e = $(this).scrollTop();
            e > i ? r.hasClass("is-sticky") || r.addClass("is-sticky") : e <= i && r.hasClass("is-sticky") && r.removeClass("is-sticky");
        }
        $(function () {
            !(function () {
                var e = [],
                ...
                (function (e, t) {
                    ...
                    $(".hamburger").click(function (e) {
                        e.preventDefault(),
                            ...
                            $("body").hasClass("is-menu") &&
                                $("html").click(function (e) {
                                    0 == $(e.target).closest(".main-header__nav").length && ($("body").removeClass("is-menu"), $(this).unbind(e));
                                });
                    }),
                    (function (e, t, n, r) {
                        var i = window.location.href,
                            a = new URL(i),
                            s = a.searchParams.get("loc"),
                            c = a.searchParams.get("dep");
                        s && ((r.location = s), e.find('.filter-select [value="' + s + '"]').attr("selected", !0)), c && ((r.department = c), e.find('.filter-select [value="' + c + '"]').attr("selected", !0)), o(e, t, n, r);
                    })(i, c, l, u),
                    $(".search__item__icon").length &&
                        $(".search__item__icon").each(function (n) {
                            var r = "icon__" + n;
                            $(this).find("object").attr({ id: r, "data-index": n });
                            var i = new Vivus(r, {
                                type: "delayed",
                                delay: 40,
                                duration: 80,
                        ...
                        ? $(".fade-elements")
                              ...
                              .each(function () {
                                  $(this).waypoint(
                                      function (e) {
                                          var t = $(this.element);
                                          t.hasClass("fade-elements__visible") || (t.addClass("fade-elements__visible"), d(t)), this.destroy();
                                      },
                              ...
                              $(this).waypoint(
                                  function (e) {
                                      ...
                                      t.children().each(function (e) {
                                          var t = $(this);
                                          t.hasClass("fade-elements__visible") ||
                                              setTimeout(function () {
                                                  t.addClass("fade-elements__visible"), d(t);
                                              }, 250 * e);
                                      }),
                                          this.destroy();
                                  },
                ...
                $(".filter-select").length &&
                    i.find(".filter-select select").on("change", function () {
                        var e = $(this),
                            t = e.val(),
                            n = e.data("sort");
                        (u[n] = t), o(i, c, l, u);
                ...
                $(".search__item").length &&
                    s.find("[data-country]").on("click", function () {
                        var e = $(this).data("country");
                        (u.location = e), i.find('.filter-select [value="' + e + '"]').attr("selected", !0), o(i, c, l, u);
                    });
                $('[data-page="scroll"]').on("click", function (e) {
                    $("body").scrollTo($(this.hash).offset().top - 70, 1600), e.preventDefault();
                });
            })();
        });
    },
    ...
    oCYn: function (e, t, n) {
        ...
        (function (e, n) {
            ...
            var ne = function () {
                    return void 0 === z && (z = !G && !W && void 0 !== e && e.process && "server" === e.process.env.VUE_ENV), z;
                },
            ...
            function xe(e, t) {
                ...
                if (c(e) && !(e instanceof pe))
                    return b(e, "__ob__") && e.__ob__ instanceof Ce ? (n = e.__ob__) : $e && !ne() && (Array.isArray(e) || u(e)) && Object.isExtensible(e) && !e._isVue && (n = new Ce(e)), t && n && n.vmCount++, n;
            }
            function ke(e, t, n, r, i) {
                ...
                if (!a || !1 !== a.configurable) {
                    ...
                    Object.defineProperty(e, t, {
                        ...
                        set: function (t) {
                            var r = s ? s.call(e) : n;
                            t === r || (t != t && r != r) || (s && !c) || (c ? c.call(e, t) : (n = t), (l = !i && xe(t)), o.notify());
                        },
                    });
                }
            }
            ...
            function Oe(e, t) {
                if (!t) return e;
                for (var n, r, i, o = Object.keys(t), a = 0; a < o.length; a++) (r = e[(n = o[a])]), (i = t[n]), b(e, n) ? r !== i && u(r) && u(i) && Oe(r, i) : Ae(e, n, i);
                return e;
            }
            function Ee(e, t, n) {
                return n
            ...
            function it(e, t, n, r, o, s) {
                ...
                for (c in e)
                    (l = e[c]),
                        (u = t[c]),
                        (f = nt(c)),
                        i(l) || (i(u) ? (i(l.fns) && (l = e[c] = rt(l)), a(f.once) && (l = e[c] = o(f.name, l, f.capture)), n(f.name, l, f.capture, f.passive, f.params)) : l !== u && ((u.fns = l), (e[c] = u)));
            ...
            function ot(e, t, n) {
                ...
                i(s) ? (r = rt([c])) : o(s.fns) && a(s.merged) ? (r = s).fns.push(c) : (r = rt([s, c])), (r.merged = !0), (e[t] = r);
            }
                    ...
                    ? (function e(t, n) {
                          ...
                          for (c = 0; c < t.length; c++)
                              i((l = t[c])) ||
                                  ...
                                  (f = r[u]),
                                  Array.isArray(l)
                                      ? l.length > 0 && (ct((l = e(l, (n || "") + "_" + c))[0]) && ct(f) && ((r[u] = me(f.text + l[0].text)), l.shift()), r.push.apply(r, l))
                                      : s(l)
                                      ? ct(f)
                                          ? (r[u] = me(f.text + l))
                                          : "" !== l && r.push(me(l))
                                      : ct(l) && ct(f)
                                      ? (r[u] = me(f.text + l.text))
                                      : (a(t._isVList) && o(l.tag) && i(l.key) && o(n) && (l.key = "__vlist" + n + "_" + c + "__"), r.push(l)));
                          return r;
                      })(e)
                    : void 0;
            }
            ...
            function ht(e, t, n) {
                (tt = e), it(t, n || {}, dt, pt, vt), (tt = void 0);
            }
            function mt(e, t) {
                var n = {};
                if (!e) return n;
            ...
            function Et() {
                ...
                for (
                    ...
                    (e = xt[Ot]).before && e.before(), (t = e.id), (At[t] = null), e.run();
                var n = kt.slice(),
                    r = xt.slice();
                ...
                (jt.prototype.update = function () {
                    this.lazy
                        ...
                        : (function (e) {
                              ...
                              if (null == At[t]) {
                                  if (((At[t] = !0), Tt)) {
                                      for (var n = xt.length - 1; n > Ot && xt[n].id > e.id; ) n--;
                                      xt.splice(n + 1, 0, e);
                                  } else xt.push(e);
                                  St || ((St = !0), Ze(Et));
                              }
                ...
                t.props &&
                    ...
                    t.data
                        ? (function (e) {
                              ...
                              for (; i--; ) {
                                  var o = n[i];
                                  0, (r && b(r, o)) || ((a = void 0), 36 !== (a = (o + "").charCodeAt(0)) && 95 !== a && Nt(e, "_data", o));
                              }
                              var a;
                              xe(t, !0);
                          })(e)
                    ...
                    t.computed &&
                        (function (e, t) {
                            ...
                            for (var i in t) {
                                ...
                                0, r || (n[i] = new jt(e, a || L, L, Dt)), i in e || Pt(e, i, o);
                            }
                        })(e, t.computed),
                    t.watch &&
                        t.watch !== Q &&
            ...
            function Pt(e, t, n) {
                var r = !ne();
                "function" == typeof n ? ((It.get = r ? Ft(t) : Rt(n)), (It.set = L)) : ((It.get = n.get ? (r && !1 !== n.cache ? Ft(t) : Rt(n.get)) : L), (It.set = n.set || L)), Object.defineProperty(e, t, It);
            }
            function Ft(e) {
                return function () {
            ...
            function Qt(e) {
                (e._o = Jt), (e._n = v), (e._s = p), (e._l = Ht), (e._t = zt), (e._q = N), (e._i = M), (e._m = Kt), (e._f = Vt), (e._k = Wt), (e._b = qt), (e._v = me), (e._e = he), (e._u = gt), (e._g = Zt);
            }
            ...
            var rn = {
                    ...
                    prepatch: function (e, t) {
                        ...
                        !(function (e, t, n, i, o) {
                            ...
                            (e.$options._parentListeners = n), ht(e, n, d), a && ((e.$slots = mt(o, i.context)), e.$forceUpdate());
            ...
            function an(e, t, n, s, l) {
                if (!i(e)) {
                    ...
                    if ((c(e) && (e = u.extend(e)), "function" == typeof e)) {
                                        ...
                                        return (
                                            c(d) &&
                                                ("function" == typeof d.then
                                                    ? i(e.resolved) && d.then(u, f)
                                                    : o(d.component) &&
                                                      "function" == typeof d.component.then &&
                                                      (d.component.then(u, f),
                                                      o(d.error) && (e.errorComp = lt(d.error, t)),
                                                      o(d.loading) &&
                                                          ((e.loadingComp = lt(d.loading, t)),
                                                          0 === d.delay
                                                              ? (e.loading = !0)
                                                              : setTimeout(function () {
                                                                    i(e.resolved) && i(e.error) && ((e.loading = !0), l(!1));
                                                                }, d.delay || 200)),
                                                      o(d.timeout) &&
                                                          setTimeout(function () {
                                                              i(e.resolved) && f(null);
                        ...
                        if (a(e.options.functional))
                            return (function (e, t, n, i, a) {
                                var s = e.options,
                                    c = {},
                                    l = s.props;
                                if (o(l)) for (var u in l) c[u] = De(u, l, t || r);
                                else o(n.attrs) && nn(c, n.attrs), o(n.props) && nn(c, n.props);
                                var f = new en(n, c, a, i, e),
                                    d = s.render.call(null, f._c, f);
                                if (d instanceof pe) return tn(d, n, f.parent, s);
                                if (Array.isArray(d)) {
                                    for (var p = st(d) || [], v = new Array(p.length), h = 0; h < p.length; h++) v[h] = tn(p[h], n, f.parent, s);
                                    return v;
                                }
                            })(e, d, t, n, s);
                        var p = t.on;
                        ...
                        return new pe("vue-component-" + e.cid + (h ? "-" + h : ""), t, void 0, void 0, void 0, n, { Ctor: e, propsData: d, listeners: p, tag: l, children: s }, f);
                    }
                }
            }
            function sn(e, t) {
            ...
            function dn(e) {
                ...
                if (e.super) {
                    ...
                    if (n !== e.superOptions) {
                        ...
                        r && O(e.extendOptions, r), (t = e.options = Ne(n, e.extendOptions)).name && (t.components[t.name] = e);
                    }
                }
                return t;
            }
                ...
                e.prototype._init = function (e) {
                    ...
                    (t._uid = fn++),
                        ...
                        e && e._isComponent
                            ...
                            : (t.$options = Ne(dn(t.constructor), e || {}, t)),
                        (t._renderProxy = t),
                        (t._self = t),
                        (function (e) {
                            var t = e.$options,
                    ...
                    KeepAlive: {
                        ...
                        render: function () {
                            ...
                            if (n) {
                                ...
                                a[c] ? ((t.componentInstance = a[c].componentInstance), g(s, c), s.push(c)) : ((a[c] = t), s.push(c), this.max && s.length > parseInt(this.max) && _n(a, s[0], s, this._vnode)), (t.data.keepAlive = !0);
                            }
                            return t || (e && e[0]);
                        },
                    },
            ...
            !(function (e) {
                ...
                Object.defineProperty(e, "config", t),
                    (e.util = { warn: se, extend: O, mergeOptions: Ne, defineReactive: ke }),
                    (e.set = Ae),
                    (e.delete = Se),
                    (e.nextTick = Ze),
                ...
                Object.defineProperty(vn, "FunctionalRenderContext", { value: en }),
                (vn.version = "2.5.21");
                ...
                (e.data.directives || t.data.directives) &&
                    (function (e, t) {
                        var n,
                            ...
                            l = [],
                            u = [];
                        for (n in c) (r = s[n]), (i = c[n]), r ? ((i.oldValue = r.value), tr(i, "update", t, e), i.def && i.def.componentUpdated && u.push(i)) : (tr(i, "bind", t, e), i.def && i.def.inserted && l.push(i));
                        if (l.length) {
                            var f = function () {
                                for (var n = 0; n < l.length; n++) tr(l[n], "inserted", t, e);
                            };
                            o ? ot(t, "insert", f) : f();
                        }
                        u.length &&
                            ot(t, "postpatch", function () {
                                for (var n = 0; n < u.length; n++) tr(u[n], "componentUpdated", t, e);
                            });
            ...
            function Qn(e, t) {
                ...
                if (!e) return i;
                for (n = 0; n < e.length; n++) (r = e[n]).modifiers || (r.modifiers = Zn), (i[er(r)] = r), (r.def = Me(t.$options, "directives", r.name));
                return i;
            }
            function er(e) {
            ...
            function rr(e, t) {
                ...
                if (!((o(n) && !1 === n.Ctor.options.inheritAttrs) || (i(e.data.attrs) && i(t.data.attrs)))) {
                    var r,
                        ...
                        c = e.data.attrs || {},
                        l = t.data.attrs || {};
                    for (r in (o(l.__ob__) && (l = t.data.attrs = O({}, l)), l)) (a = l[r]), c[r] !== a && ir(s, r, a);
                    for (r in ((J || Y) && l.value !== c.value && ir(s, "value", l.value), c)) i(l[r]) && (Tn(r) ? s.removeAttributeNS(Sn, On(r)) : kn(r) || s.removeAttribute(r));
                }
            }
            function ir(e, t, n) {
                e.tagName.indexOf("-") > -1
                    ...
                    : kn(t)
                    ? e.setAttribute(t, En(n) || "false" === n ? "false" : "true")
                    : Tn(t)
                    ? En(n)
                        ? e.removeAttributeNS(Sn, On(t))
            ...
            function sr(e, t) {
                ...
                if (!(i(r.staticClass) && i(r.class) && (i(a) || (i(a.staticClass) && i(a.class))))) {
                    ...
                    o(c) && (s = In(s, Nn(c))), s !== n._prevClass && (n.setAttribute("class", s), (n._prevClass = s));
                }
            }
            var cr,
                lr,
            ...
            function mr(e) {
                ...
                if ((void 0 === i ? (i = e.slice(0, r).trim()) : 0 !== p && m(), o)) for (r = 0; r < o.length; r++) i = yr(i, o[r]);
                return i;
            }
            function yr(e, t) {
                var n = t.indexOf("(");
            ...
            function Tr(e, t) {
                var n = (function (e) {
                    if (((e = e.trim()), (cr = e.length), e.indexOf("[") < 0 || e.lastIndexOf("]") < cr - 1)) return (fr = e.lastIndexOf(".")) > -1 ? { exp: e.slice(0, fr), key: '"' + e.slice(fr + 1) + '"' } : { exp: e, key: null };
                    (lr = e), (fr = dr = pr = 0);
                    for (; !Er(); ) Lr((ur = Or())) ? Ir(ur) : 91 === ur && jr(ur);
            ...
            function Fr(e, t, n, r) {
                ...
                (t =
                    ...
                    Nr.addEventListener(e, t, ee ? { capture: n, passive: r } : n);
            }
            function Rr(e, t, n, r) {
                ...
                if (!i(e.data.on) || !i(t.data.on)) {
                    ...
                    (Nr = t.elm),
                        (function (e) {
                            ...
                            o(e[Dr]) && ((e.change = [].concat(e[Dr], e.change || [])), delete e[Dr]);
                        })(n),
            ...
            function Hr(e, t) {
                if (!i(e.data.domProps) || !i(t.data.domProps)) {
                    var n,
                        ...
                        s = e.data.domProps || {},
                        c = t.data.domProps || {};
                    for (n in (o(c.__ob__) && (c = t.data.domProps = O({}, c)), s)) i(c[n]) && (a[n] = "");
                    for (n in c) {
            ...
            var Kr,
                ...
                Zr = ["Webkit", "Moz", "ms"],
                Qr = $(function (e) {
                    if (((Kr = Kr || document.createElement("div").style), "filter" !== (e = C(e)) && e in Kr)) return e;
            ...
            function ei(e, t) {
                ...
                if (!(i(n.staticStyle) && i(n.style) && i(r.staticStyle) && i(r.style))) {
                    ...
                    var p = (function (e, t) {
                        var n,
                            r = {};
                        if (t) for (var i = e; i.componentInstance; ) (i = i.componentInstance._vnode) && i.data && (n = Wr(i.data)) && O(r, n);
                        (n = Wr(e.data)) && O(r, n);
                        for (var o = e; (o = o.parent); ) o.data && (n = Wr(o.data)) && O(r, n);
                        return r;
                    })(t, !0);
                    for (s in f) i(p[s]) && Yr(c, s, "");
                    for (s in p) (a = p[s]) !== f[s] && Yr(c, s, null == a ? "" : a);
                }
            }
            ...
            var ai = $(function (e) {
                ...
                pi = "animationend";
            si &&
                (void 0 === window.ontransitionend && void 0 !== window.onwebkittransitionend && ((ui = "WebkitTransition"), (fi = "webkitTransitionEnd")),
                void 0 === window.onanimationend && void 0 !== window.onwebkitanimationend && ((di = "WebkitAnimation"), (pi = "webkitAnimationEnd")));
            var vi = G
            ...
            function bi(e, t) {
                var n,
                    ...
                    f = 0;
                return (
                    t === ci ? a > 0 && ((n = ci), (u = a), (f = o.length)) : t === li ? l > 0 && ((n = li), (u = l), (f = c.length)) : (f = (n = (u = Math.max(a, l)) > 0 ? (a > l ? ci : li) : null) ? (n === ci ? o.length : c.length) : 0),
                    { type: n, timeout: u, propCount: f, hasTransform: n === ci && _i.test(r[ui + "Property"]) }
                );
            }
            function $i(e, t) {
                    ...
                    if (!S || $ || "" === $) {
                        ...
                        var P = !1 !== a && !X,
                            ...
                            R = (n._enterCb = D(function () {
                                P && (yi(n, E), yi(n, O)), R.cancelled ? (P && yi(n, T), N && N(n)) : I && I(n), (n._enterCb = null);
                            }));
                        e.data.show ||
                            ...
                            P &&
                                ...
                                mi(n, O),
                                hi(function () {
                                    yi(n, T), R.cancelled || (mi(n, E), F || (ki(M) ? setTimeout(R, M) : gi(n, s, R)));
                                })),
            ...
            function xi(e, t) {
                ...
                if (!o(n._leaveCb)) {
                    ...
                    var w = (n._leaveCb = D(function () {
                        n.parentNode && n.parentNode._pending && (n.parentNode._pending[e.key] = null), _ && (yi(n, u), yi(n, f)), w.cancelled ? (_ && yi(n, l), m && m(n)) : (t(), h && h(n)), (n._leaveCb = null);
                    }));
                    y ? y(C) : C();
                }
                function C() {
                    w.cancelled ||
                        ...
                        _ &&
                            ...
                            mi(n, f),
                            hi(function () {
                                yi(n, l), w.cancelled || (mi(n, u), b || (ki($) ? setTimeout(w, $) : gi(n, s, w)));
                            })),
                        p && p(n, w),
                        _ || b || w());
                }
            ...
            var Ti = (function (e) {
                var t,
                    ...
                    c = e.modules,
                    l = e.nodeOps;
                for (t = 0; t < qn.length; ++t) for (r[qn[t]] = [], n = 0; n < c.length; ++n) o(c[n][qn[t]]) && r[qn[t]].push(c[n][qn[t]]);
                function u(e) {
                ...
                function f(e, t, n, i, s, c, u) {
                    if (
                        ...
                        var f = e.data,
                            ...
                            m = e.tag;
                        o(m)
                            ? ((e.elm = e.ns ? l.createElementNS(e.ns, m) : l.createElement(m, e)), g(e), v(e, h, t), o(f) && y(e, t), p(n, e.elm, i))
                            : a(e.isComment)
                ...
                function d(e, t) {
                    o(e.data.pendingInsert) && (t.push.apply(t, e.data.pendingInsert), (e.data.pendingInsert = null)), (e.elm = e.componentInstance.$el), m(e) ? (y(e, t), g(e)) : (Gn(e), t.push(e));
                }
                function p(e, t, n) {
                                      ...
                                      (function (e, t, n, r, a) {
                                          for (var s, c, u, d = 0, p = 0, v = t.length - 1, h = t[0], m = t[v], y = n.length - 1, g = n[0], b = n[y], w = !a; d <= v && p <= y; )
                                              i(h)
                                                  ...
                                                  : Kn(h, b)
                                                  ? (x(h, b, r, n, y), w && l.insertBefore(e, h.elm, l.nextSibling(m.elm)), (h = t[++d]), (b = n[--y]))
                                                  : Kn(m, g)
                                                  ? (x(m, g, r, n, p), w && l.insertBefore(e, m.elm, h.elm), (m = t[--v]), (g = n[++p]))
                                                  : (i(s) && (s = Jn(t, d, v)),
                                                    i((c = o(g.key) ? s[g.key] : C(g, t, d, v)))
                                                        ? f(g, r, e, h.elm, !1, n, p)
                                                        : Kn((u = t[c]), g)
                                                        ? (x(u, g, r, n, p), (t[c] = void 0), w && l.insertBefore(e, u.elm, h.elm))
                                                        : f(g, r, e, h.elm, !1, n, p),
                                                    (g = n[++p]));
                                          d > v ? _(e, i(n[y + 1]) ? null : n[y + 1].elm, n, p, y, r) : p > y && $(0, t, d, v);
                                      })(d, h, y, n, u)
                                    : o(y)
                                    ? (o(e.text) && l.setTextContent(d, ""), _(d, null, y, 0, y.length - 1, n))
                                    : o(h)
                                    ? $(0, h, 0, h.length - 1)
                ...
                return function (e, t, n, s) {
                    if (!i(t)) {
                        ...
                        if (i(e)) (u = !0), f(t, d);
                            ...
                            var p = o(e.nodeType);
                            if (!p && Kn(e, t)) x(e, t, d, null, null, s);
                            else {
                                if (p) {
                                    if ((1 === e.nodeType && e.hasAttribute(P) && (e.removeAttribute(P), (n = !0)), a(n) && S(e, t, d))) return k(t, d, !0), e;
                                    (c = e), (e = new pe(l.tagName(c).toLowerCase(), {}, [], void 0, c));
                                }
                                var v = e.elm,
                                    h = l.parentNode(v);
                                if ((f(t, d, v._leaveCb ? null : h, l.nextSibling(v)), o(t.parent)))
                                    for (var y = t.parent, g = m(t); y; ) {
                                        for (var _ = 0; _ < r.destroy.length; ++_) r.destroy[_](y);
                                        if (((y.elm = t.elm), g)) {
                                            for (var w = 0; w < r.create.length; ++w) r.create[w](Wn, y);
                ...
                inserted: function (e, t, n, r) {
                    "select" === n.tag
                        ...
                        : ("textarea" === n.tag || Un(e.type)) &&
                          ((e._vModifiers = t.modifiers), t.modifiers.lazy || (e.addEventListener("compositionstart", Ni), e.addEventListener("compositionend", Mi), e.addEventListener("change", Mi), X && (e.vmodel = !0)));
                },
            ...
            function Li(e, t, n) {
                ...
                if (!i || Array.isArray(r)) {
                    for (var o, a, s = 0, c = e.options.length; s < c; s++)
                        if (((a = e.options[s]), i)) (o = M(r, Ii(a)) > -1), a.selected !== o && (a.selected = o);
                        else if (N(Ii(a), r)) return void (e.selectedIndex !== s && (e.selectedIndex = s));
                    i || (e.selectedIndex = -1);
                }
            }
            function ji(e, t) {
            ...
            var zi = function (e) {
                ...
                Wi = O({ tag: String, moveClass: String }, Ri);
            function qi(e) {
            ...
            var Xi = {
                ...
                TransitionGroup: {
                    ...
                    render: function (e) {
                        for (
                            var t = this.tag || this.$vnode.data.tag || "span", n = Object.create(null), r = (this.prevChildren = this.children), i = this.$slots.default || [], o = (this.children = []), a = Ui(this), s = 0;
                            s < i.length;
                            s++
                        ) {
                            var c = i[s];
            ...
            var ko,
                ...
                Uo = $(ro);
            function Ho(e, t, n) {
                return { type: 1, tag: e, attrsList: t, attrsMap: Ko(t), parent: n, children: [] };
            }
            function zo(e, t) {
                (ko = t.warn || gr),
                    (Eo = t.isPreTag || j),
                ...
                var n,
                    ...
                    s = !1;
                function c(e) {
                    e.pre && (a = !1), Eo(e.tag) && (s = !1);
                    for (var n = 0; n < Oo.length; n++) Oo[n](e, t);
                }
                return (
                    (function (e, t) {
                            ...
                            if (((n = e), r && yo(r))) {
                                var l = 0,
                                    ...
                                    d = e.replace(f, function (e, n, r) {
                                        return (l = r.length), yo(u) || "noscript" === u || (n = n.replace(/<!\--([\s\S]*?)-->/g, "$1").replace(/<!\[CDATA\[([\s\S]*?)]]>/g, "$1")), Co(u, n) && (n = n.slice(1)), t.chars && t.chars(n), "";
                                    });
                                ...
                                var b = void 0,
                                    ...
                                    w = void 0;
                                if (p >= 0) {
                                    for ($ = e.slice(p); !(po.test($) || uo.test($) || ho.test($) || mo.test($) || (w = $.indexOf("<", 1)) < 0); ) (p += w), ($ = e.slice(p));
                                    (b = e.substring(0, p)), C(p);
                                }
                        ...
                        function x() {
                            ...
                            if (t) {
                                ...
                                for (C(t[0].length); !(n = e.match(fo)) && (r = e.match(so)); ) C(r[0].length), i.attrs.push(r);
                        ...
                        function k(e) {
                            ...
                            l || (i.push({ tag: n, lowerCasedTag: n.toLowerCase(), attrs: f }), (r = n)), t.start && t.start(n, f, l, e.start, e.end);
                        }
                        function A(e, n, o) {
                            var a, s;
                        ...
                        start: function (e, o, l) {
                            ...
                            J &&
                                ...
                                (o = (function (e) {
                                    for (var t = [], n = 0; n < e.length; n++) {
                                        var r = e[n];
                                        Jo.test(r.name) || ((r.name = r.name.replace(Xo, "")), t.push(r));
                                    }
                                    return t;
                                })(o));
                            var f,
                            ...
                            for (var p = 0; p < To.length; p++) d = To[p](d, t) || d;
                            function v(e) {
                                0;
                            }
                            if (
                                ...
                                a
                                    ...
                                    : d.processed ||
                                      ...
                                      Vo(d, t)),
                                n ? i.length || (n.if && (d.elseif || d.else) && (v(), Wo(n, { exp: d.elseif, block: d }))) : ((n = d), v()),
                                r && !d.forbidden)
                            )
                                if (d.elseif || d.else)
                                    !(function (e, t) {
                ...
                !(function (e) {
                    ...
                    (function (e) {
                        if ("slot" === e.tag) e.slotName = kr(e, "name");
                            ...
                            var n = kr(e, "slot");
                            n && ((e.slotTarget = '""' === n ? '"default"' : n), "template" === e.tag || e.slotScope || $r(e, "slot", n));
                        }
                    })(e),
                    (function (e) {
                        var t;
                ...
                !(function (e) {
                    ...
                    for (t = 0, n = c.length; t < n; t++) {
                        if (((r = i = c[t].name), (o = c[t].value), No.test(r)))
                            if (((e.hasBindings = !0), (a = qo(r)) && (r = r.replace(Bo, "")), Ro.test(r)))
                                (r = r.replace(Ro, "")),
                                    (o = mr(o)),
                                    (s = !1),
                                    a && (a.prop && ((s = !0), "innerHtml" === (r = C(r)) && (r = "innerHTML")), a.camel && (r = C(r)), a.sync && xr(e, "update:" + C(r), Tr(o, "$event"))),
                                    s || (!e.component && Lo(e.tag, e.attrsMap.type, r)) ? br(e, r, o) : $r(e, r, o);
                            else if (Io.test(r)) (r = r.replace(Io, "")), xr(e, r, o, a, !1);
                            else {
                                var l = (r = r.replace(No, "")).match(Fo),
                                    u = l && l[1];
                                u && (r = r.slice(0, -(u.length + 1))), Cr(e, r, i, o, u, a);
                            }
                        else $r(e, r, JSON.stringify(o)), !e.component && "muted" === r && Lo(e.tag, e.attrsMap.type, r) && br(e, r, "true");
                    }
                })(e);
            }
            function Go(e) {
                ...
                if ((t = Ar(e, "v-for"))) {
                    var n = (function (e) {
                        ...
                        var r = t[1].trim().replace(Po, ""),
                            i = r.match(Do);
                        i ? ((n.alias = r.replace(Do, "").trim()), (n.iterator1 = i[1].trim()), i[2] && (n.iterator2 = i[2].trim())) : (n.alias = r);
                        return n;
                    })(t);
                    n && O(e, n);
                }
                        ...
                        if ("input" === e.tag) {
                            ...
                            if (((r[":type"] || r["v-bind:type"]) && (n = kr(e, "type")), r.type || n || !r["v-bind"] || (n = "(" + r["v-bind"] + ").type"), n)) {
                                var i = Ar(e, "v-if", !0),
                                    ...
                                    s = Ar(e, "v-else-if", !0),
                                    c = Yo(e);
                                Go(c), wr(c, "type", "checkbox"), Vo(c, t), (c.processed = !0), (c.if = "(" + n + ")==='checkbox'" + o), Wo(c, { exp: c.if, block: c });
                                var l = Yo(e);
                                Ar(l, "v-for", !0), wr(l, "type", "radio"), Vo(l, t), Wo(c, { exp: "(" + n + ")==='radio'" + o, block: l });
                                var u = Yo(e);
                                return Ar(u, "v-for", !0), wr(u, ":type", n), Vo(u, t), Wo(c, { exp: i, block: u }), a ? (c.else = !0) : s && (c.elseif = s), c;
                            }
                        }
                    },
                },
                            ...
                            if ("select" === o)
                                !(function (e, t, n) {
                                    var r =
                                        ...
                                        "});";
                                    (r = r + " " + Tr(t, "$event.target.multiple ? $$selectedVal : $$selectedVal[0]")), xr(e, "change", r, null, !0);
                                })(e, r, i);
                                ...
                                !(function (e, t, n) {
                                    var r = n && n.number,
                                        i = kr(e, "value") || "null";
                                    br(e, "checked", "_q(" + t + "," + (i = r ? "_n(" + i + ")" : i) + ")"), xr(e, "change", Tr(t, i), null, !0);
                                })(e, r, i);
                                ...
                                !(function (e, t, n) {
                                    ...
                                    var f = Tr(t, u);
                                    c && (f = "if($event.target.composing)return;" + f), br(e, "value", "(" + t + ")"), xr(e, l, f, null, !0), (s || a) && xr(e, "blur", "$forceUpdate()");
                                })(e, r, i);
                            else if (!B.isReservedTag(o)) return Sr(e, r, i), !1;
                            return !0;
                        },
                        text: function (e, t) {
            ...
            var pa = {
                ...
                va = function (e) {
                    (this.options = e), (this.warn = e.warn || gr), (this.transforms = _r(e.modules, "transformCode")), (this.dataGenFns = _r(e.modules, "genData")), (this.directives = O(O({}, pa), e.directives));
            ...
            function $a(e, t, n) {
                return t.for && !t.forProcessed
                    ? (function (e, t, n) {
                          ...
                          return (t.forProcessed = !0), "_l((" + r + "),function(" + i + o + a + "){return " + $a(e, t, n) + "})";
                      })(e, t, n)
                    : "{key:" +
                          e +
                          ",fn:" +
                          ("function(" + String(t.slotScope) + "){return " + ("template" === t.tag ? (t.if ? "(" + t.if + ")?" + (wa(t, n) || "undefined") + ":undefined" : wa(t, n) || "undefined") : ma(t, n)) + "}") +
                          "}";
            }
            ...
            var Oa,
                ...
                function (e) {
                    ...
                    return { compile: t, compileToFunctions: Ta(t) };
                })(ta),
                ja = (La.compile, La.compileToFunctions);
            function Ia(e) {
            ...
            (vn.prototype.$mount = function (e, t) {
                ...
                if (!n.render) {
                    ...
                    if (r) {
                        0;
                        var i = ja(r, { shouldDecodeNewlines: Na, shouldDecodeNewlinesForHref: Ma, delimiters: n.delimiters, comments: n.comments }, this),
                            o = i.render,
                            a = i.staticRenderFns;
    ...
    qr4S: function (e, t, n) {
        ...
        var r = n("oCYn"),
            i = function () {
                var e = this,
                    t = e.$createElement,
                    n = e._self._c || t;
                return n("div", { ref: "videoWrapper", staticClass: "video__wrapper" }, [
                    n("section", { ref: "video", staticClass: "video" }, [
                        n("button", {
                            staticClass: "close",
                            on: {
                                click: function (t) {
                        ...
                        e._v(" "),
                        n("div", { class: [e.activateChoices ? "active" : "inactive", e.overlay] }, [
                            n("div", {
                                staticClass: "left",
                                on: {
                                    click: function (t) {
                        ...
                        n(
                            ...
                            {
                                ref: "videoGame",
                                attrs: { id: "videoGame", src: e.src, poster: e.poster, width: "900", autoplay: "", controls: e.safari },
                                on: {
                                    play: function (t) {
                                        e.playEvent();
                                    },
                    ...
                    e._v(" "),
                    n("div", { staticClass: "modal-overlay" }),
                ]);
            };
        i._withStripped = !0;
        var o = (function (e, t, n, r, i, o, a, s) {
            ...
            {
                name: "VideoGame",
                props: { srcdata: { type: Object, default: () => ({}) } },
                data: () => ({
                    src: null,
                    scene: { step: 0, src: null, srcChoice: null, choice1: null, choice2: null },
                ...
                methods: {
                    initialPlay() {
                        (this.poster = ""), this.$refs.videoWrapper.classList.add("modal");
                        (this.scene = this.srcList.scene0), (this.scene.step = 0), this.$refs.overlayButton.classList.add("inactive"), this.getNextSceneUrl(this.scene.src, null).then(function (e) {});
                    },
                    getChoice(e) {
                        (this.sceneType = "choice"), (this.choice = e);
                    },
                    setChoice(e) {
                        (this.activateChoices = !1), (this.choice = e), (this.isChoiceEnded = !1), (this.choiceMade = e);
                        ["scene19", "scene20", "scene21", "scene22"].indexOf(this.scene.choice1) > -1
                            ? ((this.lastScene = !0),
                    ...
                    getExt() {
                        let e,
                            t = ["video/mp4", "video/mov", "video/webm"],
                            n = this.$refs.videoGame;
                    ...
                    prepareFile(e, t) {
                        ...
                        return new Promise(function (e, t) {
                            let o = null,
                                a = null;
                            !0 === n.initial
                                ? (o = "//s3-eu-west-1.amazonaws.com/docplanner.com/video/" + n.fileSize + "/" + r + "." + n.ext)
                                : "choice1" === i
                                ? null !== n.srcList[n.scene.choice1].src && (o = "//s3-eu-west-1.amazonaws.com/docplanner.com/video/" + n.fileSize + "/" + n.srcList[n.scene.choice1].src + "." + n.ext)
                                : "choice2" === i
                                ? null !== n.srcList[n.scene.choice2].src && (o = "//s3-eu-west-1.amazonaws.com/docplanner.com/video/" + n.fileSize + "/" + n.srcList[n.scene.choice2].src + "." + n.ext)
                                : (o = "//s3-eu-west-1.amazonaws.com/docplanner.com/video/" + n.fileSize + "/" + r + "." + n.ext);
                                ...
                                (a.onload = function () {
                                    if (200 === a.status) {
                                        ...
                                        t.onload = function (t) {
                                            ...
                                            let o = null,
                                                a = null;
                                            (o = new Uint8Array(i)), (a = new Blob([o], { type: "video/" + n.ext })), (this.url = URL.createObjectURL(a)), e(this.url);
                                        };
                                    }
                                }),
                                a.send();
                    ...
                    bufferVideo(e) {
                        (this.isChoice = e), this.isChoiceEnded || (this.srcsBuffered = []), (new XMLHttpRequest().responseType = "blob");
                        let t = this;
                        this.getNextSceneUrl().then(function (e) {
                            let n = e;
                            !0 === t.initial && (t.generateBlob(n, null).then(function (e) {}), (t.initial = !1)),
                                !0 === t.isChoiceEnded
                                    ? !1 === t.lastScene &&
                                      t.prepareFile(null, "choice1").then(function (e) {
                                    ...
                                    : (t.isChoice, t.generateBlob(n, null).then(function (e) {}));
                        });
                    },
                    asyncBuffer(e, t) {
                        let n = this;
                        ...
                        return new Promise(function (e, t) {
                            (n.xhr = new XMLHttpRequest()),
                                ...
                                (n.xhr.onload = function () {
                                    200 === n.xhr.status ? e({ xhrResponse: n.xhr.response, choiceNo: i }) : t(Error("Image didn't load successfully; error code:" + n.xhr.statusText));
                                }),
                    ...
                    generateBlob(e, t) {
                        ...
                        return new Promise(function (r, i) {
                            !0 === n.isChoiceEnded
                                ? "choice1" === t
                                    ? ((n.choice1 = e), (n.srcsBuffered[0] = e), r())
                                    : "choice2" === t && ((n.choice2 = e), (n.srcsBuffered[1] = e), r())
                                : !1 === n.isChoiceEnded && !0 === n.isChoice
                                ? ((n.srcsBuffered[0] = e), r())
                                : ((n.srcsBuffered[0] = e),
                            ...
                            this.playPromise
                                .then((e) => {
                                    !0 === this.initial
                                        ? this.bufferVideo(!1)
                                        : this.isChoiceEnded
                                        ? (this.bufferVideo(), this.setNextSceneData(this.choice), (this.isChoice = !1), (this.currentScene = null), (this.isChoiceEnded = !0))
                                        : this.isChoice
                                        ? !1 === this.lastScene &&
                                          (this.currentScene = this.this.$refs.videoGame.oncanplay = () => {
                                              this.setNextSceneData(), this.$refs.videoGame.play();
                                          })
                                        : this.$refs.videoGame.play();
                                })
                                .catch((e) => {}));
                    ...
                    endEvent() {
                        if (!1 === this.lastScene)
                            if ((this.isChoice ? (this.isChoice = !1) : (this.isChoice = !0), null !== this.currentScene)) {
                                let e = this;
                                null === e.scene.choice1
                                    ? (e.lastScene = !0)
                                    : this.prepareFile(this.scene.srcChoice, null).then(function (t) {
                                          t.match(/blob/g)
                                              ? ((e.src = t),
                                                (e.isChoice = !0),
                                                (e.isChoiceEnded = !0),
                                              ...
                                              : e.generateBlob(t, null).then(function (t) {
                                                    (e.src = t), (e.isChoice = !0), (e.isChoiceEnded = !0), (e.activateChoices = !0);
                                                });
                                      });
                            } else this.isChoiceEnded ? (this.activateChoices = !0) : this.isChoiceEnded || this.autoload();
                        else this.scrollDownButtonActivate = !0;
                    },
                    autoload() {
                    ...
                    getNextSceneUrl(e) {
                        ...
                        return new Promise(function (n, r) {
                            !0 === t.initial
                                ? t.prepareFile(t.scene.src, null).then(function (e) {
                                      t.generateBlob(e).then(function (e) {
                                          n(), (t.initial = !1), (t.isChoice = !0), (t.playPromise = t.$refs.videoGame.play());
                                      });
                                  })
                                : !0 === t.isChoice
                                ? ((t.isChoiceEnded = !0),
                    ...
                    setNextSceneData(e) {
                        ...
                        if (void 0 !== e) {
                            if ("left" === e) {
                                (t = this.srcList[this.scene.choice1]), (this.currentScene = t.src);
                                let e = this.scene.step + 1;
                                (this.scene = t), (this.scene.step = e), (this.choice = null), (this.choiceMade = void 0);
                            } else if ("right" === e) {
                                (t = this.srcList[this.scene.choice2]), (this.currentScene = t.src);
                                let e = this.scene.step + 1;
                                (this.scene = t), (this.scene.step = e), (this.choice = null), (this.choiceMade = void 0);
                            }
                        } else
                            null !== this.currentScene
                                ? ((t = this.srcList[this.currentScene]), (this.scene = { step: this.scene.step + 1, src: t.src, srcChoice: t.srcChoice, choice1: t.choice1, choice2: t.choice2 }))
                                : !1 === this.isChoice && ((t = this.srcList["scene" + (this.scene.step + 1)]), (this.scene = { step: this.scene.step + 1, src: t.src, srcChoice: t.srcChoice, choice1: t.choice1, choice2: t.choice2 }));
                    },
                    ...
                    closeVideo() {
                        (this.src = null),
                            (this.scene = { step: 0, src: null, srcChoice: null, choice1: null, choice2: null }),
                            (this.choice = null),
                        ...
                        (this.$refs.videoGame.src = null), e.classList.remove("modal"), this.$refs.overlayButton.classList.remove("inactive"), (this.playPromise = this.$refs.videoGame.load()), this.$refs.videoGame.pause();
                    },
                    showDefinitiveScene() {
                        let e = this;
                        let t = this.scene.srcChoice.match(/.+?(?=\/)/);
                        this.prepareFile(t + "/8_endsequence", null).then(function (t) {
                            (e.src = t), (e.definitiveScene = !0);
                        });
                    },
                    scrollDown() {
                    ...
                    animate(e, t, n, r, i, o, a) {
                        ...
                        let s = new Date().getTime(),
                            c = setInterval(function () {
                                ...
                                a ? (e[t] = r + l * (i - r) + n) : (e.style[t] = r + l * (i - r) + n), 1 === l && clearInterval(c);
                            }, 25);
                        a ? (e[t] = r + n) : (e.style[t] = r + n);
                    },
                },
                created() {
                    this.prepareSrcList(this.srcdata), (this.fileSize = "480");
                },
                mounted() {
                    this.getExt();
                },
        ...
        r.a.component("video-game", a),
            (navigator.vendor && navigator.vendor.indexOf("Apple") > -1 && navigator.userAgent && -1 == navigator.userAgent.indexOf("CriOS") && -1 == navigator.userAgent.indexOf("FxiOS")) ||
                new r.a({ el: "#video", components: { VideoGame: a } });
    },
    sXUG: function (e, t, n) {
        n("qr4S"), n("Cw/M"), n("FkTd");
    },
    yLpj: function (e, t) {
        var n;
        n = (function () {
